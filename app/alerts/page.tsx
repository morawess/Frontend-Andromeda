                  ...
                  {pagosPendientes.map((p) => (
                    <Card key={p.id} className="flex flex-col gap-3 p-4 border-rose-200/50 bg-rose-50/30">
                      ...
                      <div className="flex items-center justify-between mt-1">
                        ...
                        <Button size="sm" variant="outline" className="h-8 gap-1.5" render={<Link href={`/payments/${p.alumnoId}`} />}>
                          Cobrar
                  ...
                  {alumnosSinApto.map((a) => (
                    <Card key={a.id} className="flex flex-col gap-3 p-4 border-amber-200/50 bg-amber-50/30">
                      ...
                      <div className="flex items-center justify-between mt-1">
                        ...
                        <Button size="sm" variant="outline" className="h-8 gap-1.5" render={<Link href={`/students/${a.id}/editar`} />}>
                          Actualizar
                          <ArrowRight className="size-3.5" />
                        </Button>
                      </div>
