  ...
  return (
    <div className="w-full max-w-[400px] rounded-[24px] bg-white p-8 shadow-2xl">
      <div className="mb-6 flex justify-center">
         <Image src="/logo.png" alt="Andromeda Studio" width={48} height={48} className="object-contain" />
      </div>
      ...
      {step === "email" && (
        ...
        >
          ...
          <Link href="/auth/login" className="text-[11px] font-medium text-center text-gray-500 hover:text-purple-700 transition-colors mt-2">
